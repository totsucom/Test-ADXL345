...
#define I2C_CLOCK_66KHZ		47
#define I2C_CLOCK_100KHZ	31
#define I2C_CLOCK_400KHZ	7
void vSMBusInit(uint8 prescaler);

bool_t bSMBusWrite(uint8 u8Address, uint8 u8Command,
						  uint8 u8Length, uint8* pu8Data);

//bool_t bSMBusRandomRead(uint8 u8Address, uint8 u8Command,
//						       uint8 u8Length, uint8* pu8Data);

//bool_t bSMBusRandomRead_NACK(uint8 u8Address, uint8 u8Command,
//						       uint8 u8Length, uint8* pu8Data);

bool_t bSMBusSequentialRead(uint8 u8Address, uint8 u8Length,
								   uint8* pu8Data);

bool_t bSMBusWait(void);
