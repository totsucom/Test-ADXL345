...
void vSMBusInit(uint8 prescaler)
{
	...
	/* run bus at 400KHz */
	//47:66khz 31:100khz 7:400khz
	vAHI_SiMasterConfigure(TRUE, FALSE, prescaler);
}
...
/*
bool_t bSMBusRandomRead(uint8 u8Address, uint8 u8Command, uint8 u8Length, uint8* pu8Data)
{
